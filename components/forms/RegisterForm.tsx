  ...
  const onSubmit = async (values: z.infer<typeof PatientFormValidation>) => {
    ...
    try {
      const patient = {
        ...
        identificationDocumentUrl: fileId? `https://fra.cloud.appwrite.io/v1/storage/buckets/${process.env.NEXT_PUBLIC_BUCKET_ID}/files/${fileId}/view?project=${process.env.APPWRITE_PROJECT_ID}`
          : 'https://example.com/placeholder-document-url',
